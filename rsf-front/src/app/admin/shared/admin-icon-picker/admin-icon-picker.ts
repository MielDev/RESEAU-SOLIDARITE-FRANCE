...
const ADMIN_ICON_OPTIONS: AdminIconOption[] = [
  ...
  { label: 'Calendrier', className: 'fas fa-calendar-days', category: 'Actualites', keywords: 'date actualite' },
  { label: 'Gateau', className: 'fas fa-cake-candles', category: 'Actualites', keywords: 'rencontre anniversaire' },
  { label: 'Micro', className: 'fas fa-microphone', category: 'Actualites', keywords: 'prise parole' },
  { label: 'Tasse', className: 'fas fa-mug-saucer', category: 'Actualites', keywords: 'cafe accueil' },
  { label: 'Repas', className: 'fas fa-utensils', category: 'Actualites', keywords: 'dejeuner nourriture' },
  { label: 'Jeu', className: 'fas fa-dice', category: 'Actualites', keywords: 'animation ludique' },
  { label: 'Musique', className: 'fas fa-music', category: 'Actualites', keywords: 'concert ambiance' },
  { label: 'Ticket', className: 'fas fa-ticket', category: 'Actualites', keywords: 'participation entree' },
